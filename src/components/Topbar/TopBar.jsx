    ...
    <div className="top">
      ...
      <div className="topCentre">
        <ul className="topList">
          ...
          <li className="topList-item"><Link to="/employer">Employer</Link></li>
          <li className="topList-item"><Link to="/Candidate">Candidate</Link></li>
        </ul>
      </div>
      <div className="topRight">
        <ul className="topList">
          {user ? (
            ...
            <li className="topList-item">  <Link to="/sign-in">Sign-in</Link></li>
          )}
